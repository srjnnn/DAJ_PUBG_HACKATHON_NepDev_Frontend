...
import Header from '../../components/header.jsx'; // Corrected file casing to match the file name
...
export default function VolunteerProfile() {
  ...
  // The main container is now centered and has a maximum width for better readability on larger screens.
  return (
    <div className="min-h-dvh bg-gradient-to-b from-gray-100 to-gray-200 p-4 flex flex-col items-center">
      <div className="w-full max-w-lg"> {/* This div centers the content and limits its width */}
        <Header id="volunteer"/>
        ...
        <div className="flex space-x-2 mb-6 mt-4 justify-center overflow-x-auto">
          {["join", "sessions",].map((tab) => (
            ...
            >
              {tab === "join" ? "Join Peer Group" : tab === "sessions" ? "Scheduled Sessions" : "Feedback & Notes"}
            </button>
          ))}
        </div>
